...
namespace Orm.Orm.Framework
{
    public class ConfigurationManager
    {
        static ConfigurationManager()
        {
            ...
            _SqlConnectionStringOther = configuration["ConnectionStrings:Other"];
        ...
        private static string _SqlConnectionStringOther;
        public static string SqlConnectionStringOther
        {
            get
            {
                return _SqlConnectionStringOther;
            }
        }
    }
}
